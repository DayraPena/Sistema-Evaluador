...
class ReporteAlumnosSA extends StatefulWidget {
  const ReporteAlumnosSA({super.key});

  @override
  State<ReporteAlumnosSA> createState() => _ReporteAlumnosSAState();
}

class _ReporteAlumnosSAState extends State<ReporteAlumnosSA> {
  String? ciclo;
  String? anio;
