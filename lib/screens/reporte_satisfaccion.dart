...
import 'reporte_satis_Docente.dart';
import 'reporte_satis_Alumno.dart';

class ReporteSatisfaccion extends StatelessWidget {
  @override
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                _menuButton(context, 'Docentes', ReporteDocentesSA()),
                const SizedBox(height: 20),
                _menuButton(context, 'Alumnos', ReporteAlumnosSA()),
              ],
            ),
          ),
          const Spacer(),
