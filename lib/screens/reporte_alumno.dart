...
class ReporteAlumnos extends StatefulWidget {
  const ReporteAlumnos({super.key});

  @override
  State<ReporteAlumnos> createState() => _ReporteAlumnosState();
}

class _ReporteAlumnosState extends State<ReporteAlumnos> {
  String? ciclo;
  String? anio;
