...
class ReporteDocentesSA extends StatefulWidget {
  const ReporteDocentesSA({super.key});

  @override
  State<ReporteDocentesSA> createState() => _ReporteDocentesSAState();
}

class _ReporteDocentesSAState extends State<ReporteDocentesSA> {
  String? ciclo;
  String? anio;
